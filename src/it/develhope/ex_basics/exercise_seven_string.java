...
public class exercise_seven_string {
    ...
    private static void exercise1() {
        ...
        ourNumberInt += 2;
        ourNumberStr = Integer.toString(ourNumberInt);
    ...
    private static void exercise4() {
        ...
        startInt *= 2;
        startStr = Integer.toString(startInt);
        startStr += startStr;
        double startDou = Double.parseDouble(startStr);
        startDou = startDou / 3.5;
        startDou = Math.floor(startDou);

        System.out.println(startDou);
